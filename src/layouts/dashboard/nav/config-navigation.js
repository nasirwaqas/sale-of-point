  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'income', 
        ...
        icon: ICONS.income,
        children: [
          { title: 'new', path: PATH_DASHBOARD.income.new, },
          { title: 'history', path: PATH_DASHBOARD.income.history,  },
          { title: 'types', path: PATH_DASHBOARD.income.types,  },
        ],
      },
      { title: 'expense', 
        ...
        icon: ICONS.expense,
        children: [
          { title: 'new', path: PATH_DASHBOARD.expense.new,  },
          { title: 'history', path: PATH_DASHBOARD.expense.history,  },
          { title: 'types', path: PATH_DASHBOARD.expense.types,  },
        ],
      },
      { title: 'purchase', 
